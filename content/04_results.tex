...
\begin{equation}
    ...
    \label{eqn:fit_hf}
\end{equation}
The only important parameters in the context of this thesis being the amplitude and the frequency of the modes, the FFT represents another approach.
...
A pump wavelength dependence on pure NiO had already been done by Bossini et al. \lit{Bossini et al.} which is also featured here and which some of the following explanations are based on.
...
This coincides with the extensive amount of values found in the literature \lit{3 magnon modes}.
